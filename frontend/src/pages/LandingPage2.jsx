  ...
  return (
    <div className={`doc-page doc-page-${theme}`}>
      ...
      <header className="doc-nav">
        <a className="doc-brand" href="#top">
        ...
        <div className="doc-nav-actions">
          <button className="doc-theme-btn" onClick={toggle} aria-label="Toggle theme">
            {isDark ? <Sun size={16} strokeWidth={1.8} /> : <Moon size={16} strokeWidth={1.8} />}
          </button>
          <Link className="doc-cta-btn" to="/login">
            Ouvrir l'app <ArrowRight size={15} strokeWidth={2} />
          </Link>
        </div>
      </header>
      ...
      <main id="top">
        <section className={`landing-page landing-page-${theme} doc-landing-hero-wrap`}>
          <div className="landing-hero">
            <div className="landing-hero-copy">
              ...
              <div className="landing-proof-row" aria-label="Points forts du produit">
        ...
        <section className="doc-section doc-section-alt" id="presentation">
          ...
          <div className="doc-present-layout">
            ...
            <div className="doc-present-visual">
              <div className="doc-macbook-wrap">
                <img
                  src="/dashboard-preview.png"
                  alt="FinCoach Dashboard"
                  className="doc-macbook-screen"
                />
                <img
                  src="/macbook-mockup.png"
                  alt=""
                  aria-hidden="true"
                  className="doc-macbook-frame"
                />
              </div>
            </div>
          </div>
        ...
        {/* ── CTA ── */}
        <section className="doc-section doc-cta-section">
          <div className="doc-cta-inner">
            <Bot size={32} strokeWidth={1.6} color="#818cf8" />
            <h2>Accéder à l'application</h2>
            <p>Créez un compte, chargez des données de démonstration ou importez votre CSV.</p>
            <div className="doc-cta-btns">
              <Link className="doc-btn-primary" to="/register">
                Créer un compte <ArrowRight size={16} strokeWidth={2} />
              </Link>
              <Link className="doc-btn-secondary" to="/login">
                Se connecter <ChevronRight size={16} strokeWidth={2} />
              </Link>
            </div>
          </div>
        </section>
